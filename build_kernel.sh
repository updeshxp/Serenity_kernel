...
S_BUILD=BQK5
S_DATE=$(date +%Y%m%d)
S_TOOLCHAIN=/home/updeshsr/Toolchain/arm-eabi-4.9/bin/arm-eabi-
...
PACK_A35_ZIP()
{
	...
	sed -i s'/QSVER/v1.6-fix/'g $S_DIR/serenity/work/META-INF/com/google/android/updater-script
